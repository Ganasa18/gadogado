    ...
    <div className="max-w-4xl p-6 mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {steps.map((s, i) => (
          <div
            key={i}
            className="relative p-8 bg-card border border-border  space-y-4 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
      ...
      <div className="bg-card border border-border  p-8 shadow-sm space-y-4">
      ...
      <div className="from-primary to-primary-foreground p-1 rounded-[2.5rem] shadow-2xl shadow-primary/20">
